...
EDITABLE_PARAMS = [
    ...
    {"key": "STARLINK_SYSTEM_METRICS_INTERVAL_SEC", "type": "int", "default": "60", "label": "Інтервал запису CPU/пам'яті/температури, сек"},
    {"key": "STARLINK_DISH_METRICS_BATCH_INTERVAL_SEC", "type": "int", "default": "30", "label": "Інтервал batch-запису dish-метрик, сек"},
    {"key": "STARLINK_DB_INTEGRITY_CHECK_INTERVAL_SEC", "type": "int", "default": "86400", "label": "Інтервал перевірки цілісності БД, сек"},
    {"key": "STARLINK_AUTO_BACKUP_ENABLED", "type": "bool", "default": "1", "label": "Автоматичний періодичний backup (0/1)"},
    {"key": "STARLINK_AUTO_BACKUP_INTERVAL_SEC", "type": "int", "default": "604800", "label": "Інтервал автоматичного backup, сек"},
    {"key": "STARLINK_AUTO_BACKUP_KEEP_COUNT", "type": "int", "default": "4", "label": "Скільки останніх backup-ів зберігати"},
    ...
    {"key": "STARLINK_NOTIFY_PI_STARTUP", "type": "bool", "default": "1", "label": "Сповіщати про запуск Pi після перезавантаження (0/1)"},
    {"key": "STARLINK_SCHEDULED_REBOOT_ENABLED", "type": "bool", "default": "0", "label": "Плановий reboot Starlink Mini по таймеру (0/1)"},
    {"key": "STARLINK_SCHEDULED_REBOOT_INTERVAL_HOURS", "type": "float", "default": "24", "label": "Інтервал планового reboot, годин"},
    {"key": "STARLINK_SHUTDOWN_BUTTON_POLL_INTERVAL_SEC", "type": "float", "default": "0.1", "label": "Опитування GPIO кнопки виключення, сек"},
    {"key": "STARLINK_DISPLAY_BUTTON_POLL_INTERVAL_SEC", "type": "float", "default": "0.1", "label": "Опитування GPIO кнопки дисплея, сек"},
    {"key": "STARLINK_TELEGRAM_SEND_TIMEOUT_SEC", "type": "float", "default": "10", "label": "Telegram-бот: timeout надсилання, сек"},
    {"key": "STARLINK_TELEGRAM_POLL_TIMEOUT_SEC", "type": "float", "default": "30", "label": "Telegram-бот: timeout long-polling, сек"},
    {"key": "STARLINK_TELEGRAM_CONFIRM_TTL_SEC", "type": "float", "default": "120", "label": "Telegram-бот: TTL підтвердження команд, сек"},
    {"key": "STARLINK_TELEGRAM_NOTIFY_TIMEOUT_SEC", "type": "float", "default": "10", "label": "Telegram-сповіщення: timeout запиту, сек"},
    {"key": "STARLINK_TELEGRAM_SEND_RETRIES", "type": "int", "default": "1", "label": "Telegram: повторних спроб при мережевій помилці"},
    {"key": "STARLINK_TELEGRAM_SEND_RETRY_DELAY_SEC", "type": "float", "default": "2", "label": "Telegram: затримка між повторами, сек"},
    {"key": "STARLINK_TELEGRAM_ID_LIST_MAX_ITEMS", "type": "int", "default": "40", "label": "/id: макс. тарілок у списку без аргументу"},
    ...
    {"key": "STARLINK_DISPLAY_RST_PIN", "type": "int", "default": "24", "label": "Дисплей: GPIO-пін RES"},
    {"key": "STARLINK_DISPLAY_BL_PIN", "type": "int", "default": "18", "label": "Дисплей: GPIO-пін підсвітки (0=не керувати)"},
    {"key": "STARLINK_DISPLAY_WIDTH", "type": "int", "default": "170", "label": "Дисплей: ширина, px"},
    {"key": "STARLINK_DISPLAY_HEIGHT", "type": "int", "default": "320", "label": "Дисплей: висота, px"},
    {"key": "STARLINK_DISPLAY_ROTATION", "type": "int", "default": "0", "label": "Дисплей: поворот, ° (0/90/180/270)"},
