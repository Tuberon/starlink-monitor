...
EDITABLE_PARAMS = [
    ...
    {"key": "STARLINK_DISPLAY_DC_PIN", "type": "int", "default": "9", "label": "Дисплей: GPIO-пін DC"},
    {"key": "STARLINK_DISPLAY_RST_PIN", "type": "int", "default": "27", "label": "Дисплей: GPIO-пін RES"},
    {"key": "STARLINK_DISPLAY_BL_PIN", "type": "int", "default": "19", "label": "Дисплей: GPIO-пін підсвітки (0=не керувати)"},
