...
EDITABLE_PARAMS = [
    ...
    {"key": "STARLINK_DISPLAY_SPI_PORT", "type": "int", "default": "0", "label": "Дисплей: SPI-порт"},
    {"key": "STARLINK_DISPLAY_SPI_CS", "type": "int", "default": "0", "label": "Дисплей: SPI chip-select"},
    ...
    {"key": "STARLINK_DISPLAY_ROTATION", "type": "int", "default": "0", "label": "Дисплей: поворот, ° (0/180; 90/270 лише якщо width=height)"},
    {"key": "STARLINK_DISPLAY_OFFSET_LEFT", "type": "int", "default": "0", "label": "Дисплей: зміщення X відносно GRAM, px"},
