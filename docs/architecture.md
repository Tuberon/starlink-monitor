...
напряму в конструктор як `x_offset`/`y_offset`; типова потреба для
дешевих ST7789-клонів, де видима область менша за фізичний GRAM
контролера, підбирається емпірично.
