...
**Завжди приглушені окремі сповіщення** (журнал подій не зачіпається,
лише Telegram-звіт не надсилається): помилка перевірки оновлення ПЗ
роутера, попередження роутера "оновлення очікує встановлення",
попередження dish "роумінг" — шумні для сповіщення в реальному часі.
