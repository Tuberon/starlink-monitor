...
- **Будь-яка зміна версії прошивки** dish/router — "🔄 Прошивка X
  оновлена: стара → нова" для звичайного оновлення вперед, **"⏪
  Прошивка X відкочена (можливо, SpaceX-side): нова → стара"**, коли
  напрямок зміни назад (SpaceX інколи відкочує проблемні білди
  глобально — без цього розрізнення "оновлена" вводило б в оману для
  факту, що насправді downgrade)
