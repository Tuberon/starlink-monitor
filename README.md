...
9. Приймає команди в Telegram-чаті з ботом: `/status` (стан оновлень
   ...
   усіх колись підключених тарілок або деталі конкретної — версії ПЗ
   dish/router і час останнього оновлення), `/help`.
...
- `/id` — список усіх колись підключених тарілок (ID, час останнього
  бачення); `/id <ID або частина ID>` — версії ПЗ dish/router для
  конкретної тарілки і час останнього встановленого оновлення кожної
- `/help` — список команд
