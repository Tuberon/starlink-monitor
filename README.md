...
`app/signature_phrases.txt` не перезаписується. SHA-256-перевірка
запобігає повторному встановленню того самого архіву; шлях можна
вказати аргументом (`update.sh /шлях/до/архіву.tar.gz`).
